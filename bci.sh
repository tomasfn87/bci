...
echo "BCI - Brief Case Insensitive Filename and Content Search v0.03"
...
echo
echo "
Thanks for using BCI search script, the best way to print a small and colored search output.
"
